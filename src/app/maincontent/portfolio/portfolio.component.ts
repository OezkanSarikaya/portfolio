...
export class PortfolioComponent {
  ...
  portfolios: Portfolio[] = [
    {
      headline: 'Videoflix',
      subheadline: 'Angular | Python | Django REST Framework',
      text: 'A Video Streaming Platform just like Netflix',
      deutsch:'Eine Video-Streaming-Plattform wie Netflix',
      image:'./../../../assets/img/projectimages/videoflix.png',
      githubUrl:'https://github.com/OezkanSarikaya/videoflix_backend',
      demoUrl:'https://videoflix.oezkan-sarikaya.de/',
      index: 1
    }, 
    {
      headline: 'Coderr',
